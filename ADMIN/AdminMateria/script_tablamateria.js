                ...
                success: (respAX) => {
                    ...
                    materias.forEach((element, index) => {
                        if (element.Estatus == 1) {
                            ...
                            <td> ${element.HorasTeo} </td>
                            <td> ${element.HorasLab} </td>
                            <td>
                                <button class="btn btn-sm btn-primary"><i class="fa-solid fa-pencil"></i></button>
                                <button class="btn btn-sm btn-danger" onclick="eliminarMateria(${element.IDMateria})"><i class="fa-solid fa-trash-can"></i></button>
                            </td>
                        </tr>`
                        }
                    });

                    tabla_materias.innerHTML = content;
                    resolve();
                },
                error: (err) => {
...
create.addEventListener('click', () => {
    ...
    let col_teo = document.createElement("td");
    let teo = document.createElement("input");
    teo.setAttribute("name", "teo");
    teo.setAttribute("id", "teo");
    teo.setAttribute("class", "fs-10  d-flex justify-content-between rounded-pill border border-black");
    col_teo.appendChild(teo);
    element.appendChild(col_teo); 
    let col_lab = document.createElement("td");
    let lab = document.createElement("input");
    lab.setAttribute("name", "lab");
    lab.setAttribute("id", "lab");
    lab.setAttribute("class", "fs-10  d-flex justify-content-between rounded-pill border border-black");
    col_lab.appendChild(lab);
    element.appendChild(col_lab);
    ...
    bot.addEventListener('click', () => {
        ...
        let hlab = $('#lab').val();
        let datos = {
            "nombre": nom, "teo": hteo, "lab": hlab,
        }
        Swal.fire({
            title: "¿Esta Seguro?",
            text: "Agregará la materia: " + nom + ", con: " + hteo + " horas de teoría y " + hlab + " horas de laboratorio",
            icon: "question",
            showCancelButton: true,
            confirmButtonColor: "#3085d6",
            cancelButtonColor: "#d33",
