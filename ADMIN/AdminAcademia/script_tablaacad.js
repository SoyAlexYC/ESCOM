                ...
                success: (respAX) => {
                    ...
                    acad.forEach((element, index) => {
                        if (element.Estatus == 1) {
                            ...
                            <td> ${element.NomAcademia} </td>
                            <td>
                                <button class="btn btn-sm btn-primary"><i class="fa-solid fa-pencil"></i></button>
                                <button class="btn btn-sm btn-danger" onclick="eliminarAcad(${element.IDAcademia})"><i class="fa-solid fa-trash-can"></i></button>
                            </td>
                        </tr>`
                        }
                    });

                    tabla_acad.innerHTML = content;
                    resolve();
                },
                error: (err) => {
