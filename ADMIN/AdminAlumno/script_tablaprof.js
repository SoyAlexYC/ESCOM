...
create.addEventListener('click', () => {
    ...
    let col_apep = document.createElement("td");
    let apep = document.createElement("input");
    apep.setAttribute("name", "apep");
    apep.setAttribute("id", "apep");
    apep.setAttribute("class", "fs-10 w-100 d-flex justify-content-between rounded-pill border border-black");
    col_apep.appendChild(apep);
    element.appendChild(col_apep);
    let col_apem = document.createElement("td");
    let apem = document.createElement("input");
    apem.setAttribute("name", "apem");
    apem.setAttribute("id", "apem");
