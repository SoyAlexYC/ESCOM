                ...
                success: (respAX) => {
                    ...
                    grupos.forEach((element, index) => {
                        if (element.Estatus == 1) {
                            ...
                            <td> ${element.NombreGru} </td>
                            <td>
                                <button class="btn btn-sm btn-primary"><i class="fa-solid fa-pencil"></i></button>
                                <button class="btn btn-sm btn-danger" onclick="eliminarGrupo(${element.IDGrupo})"><i class="fa-solid fa-trash-can"></i></button>
                            </td>
                        </tr>`
                        }
                    });

                    tabla_grupos.innerHTML = content;
                    resolve();
                },
                error: (err) => {
